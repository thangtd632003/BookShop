...
<!-- Modal để nhập dữ liệu chỉnh sửa id và loại sách -->
...
<!-- Nó nhận một tham số button từ category cần chỉnh sửa  là nút được nhấn để mở modal rồi gán các giá trị ở modal   -->
<script>
